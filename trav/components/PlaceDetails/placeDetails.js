...
const PlaceDetails = ({place}) => {
    ...
    return (
        <Card elevation={6}>
            <CardMedia
                style={{ height: 350}}
                image={place.image ? place.photo.images.large.url: 'https://www.foodserviceandhospitality.com/wp-content/uploads/2016/09/Restaurant-Placeholder-001.jpg'}
                title={place.name}
                />
            <CardContent>
                ...
                {place?.address && (
                    <Typography gutterBottom variant="body2" color="textSecondary" className={classes.subtitile}>
